    ...
    <>
      ...
      <body>
        <div className="div-sidebar">
          ...
          <Link to="/"><li className="li-sidebar" style={{ '--i': 8 }}><a className="a-sidebar" >Inicio</a><img className="img-sidebar" src="https://cdn-icons-png.flaticon.com/128/69/69524.png"/></li></Link>
          <Link to="/estadisticas"><li className="li-sidebar" style={{ '--i': 6 }}><a className="a-sidebar" >Estadísticas</a><img className="img-sidebar" src="https://cdn-icons-png.flaticon.com/128/603/603066.png"/></li></Link>
          <Link to="/users"><li className="li-sidebar" style={{ '--i': 5 }}><a className="a-sidebar" ><img className="img-sidebar" src="https://cdn-icons-png.flaticon.com/128/12117/12117593.png"/>Usuarios</a></li></Link>
