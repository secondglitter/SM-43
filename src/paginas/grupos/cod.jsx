...
const product = {
  ...
  breadcrumbs: [
    ...
    { id: 2, name: 'First person', href: '#' },
    { id: 3, name: 'Shooter', href: '#' },
  ],
  images: [
    {
      src: '/imagenes/cod3.jpg',
      alt: 'Two each of gray, white, and black shirts laying flat.',
    },
    {
      src: '/imagenes/cod2.jpg',
      alt: 'Model wearing plain black basic tee.',
    },
    {
      src: '/imagenes/cod1.jpg',
  ...
  highlights: [
    'Programadores: Activision, Treyarch, Infinity Ward, MÁS',
    'Diseñadores: Mohammad Alavi, David Vonderhaar, MÁS',
    'Distribuidores: Activision, Activision Blizzard, Square Enix, MÁS',
    'Idiomas: alemán y español',
    'Modos de juego: Un jugador, multijugador y cooperativo',
    'Motor: Id Tech 3, Treyarch NGL e IW engine',
  ],
}
const reviews = { href: '#', average: 5, totalCount: 120000 }
