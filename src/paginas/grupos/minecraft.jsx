...
const product = {
  ...
  images: [
    ...
    {
      src: '/imagenes/Minecraft1.jpg',
      alt: 'Model wearing plain black basic tee.',
    },
    {
      src: '/imagenes/Minecraft3.jpg',
      alt: 'Model wearing plain gray basic tee.',
    },
    {
      src: '/imagenes/Minecraft2.jpg',
  ...
  highlights: [
    ...
    'Programadores: Mojang Studios, Xbox Game Studios, MÁS',
    'Fecha de estreno inicial: 18 de noviembre de 2011',
    'Diseñadores: Markus Persson, Jens Bergensten, MÁS',
    'Distribuidores: Mojang Studios, Xbox Game Studios, Telltale Games, Sony Interactive Entertainment',
  ],
}
const reviews = { href: '#', average: 4, totalCount: 11700 }
