...
const product = {
  ...
  images: [
    ...
    {
      src: '/imagenes/lol1.jpg',
      alt: 'Model wearing plain black basic tee.',
    },
    {
      src: '/imagenes/lol3.jpg',
      alt: 'Model wearing plain gray basic tee.',
    },
    {
      src: '/imagenes/lol2.jpg',
  ...
  highlights: [
    ...
    'Plataformas: GeForce Now, macOS, PlayStation 4, Xbox One, Microsoft Windows, Mac OS',
    'Fecha de estreno inicial: 27 de octubre de 2009',
    'Modo: Videojuego multijugador',
    'Nominaciones: The Game Award al Mejor Juego de eSports, MÁS',
    'Diseñadores: Steve Feak, Mark Yetter, Tom Cadwell, David Capurro, Rob Garrett, Christina Norman',
  ],
}
const reviews = { href: '#', average: 4, totalCount: 11000 }
