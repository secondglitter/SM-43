...
const product = {
  ...
  breadcrumbs: [
    ...
    { id: 3, name: 'First and third person', href: '#' },
    { id: 3, name: 'Open world', href: '#' },
  ],
  images: [
    {
      ...
      {
        src: '/imagenes/Redead3.jpg',
        alt: 'Model wearing plain black basic tee.',
      },
      {
        src: '/imagenes/Redead1.jpg',
        alt: 'Model wearing plain gray basic tee.',
      },
      {
        src: '/imagenes/Redead2.jpg',
  ...
  highlights: [
    ...
    'Géneros: Videojuego de mundo abierto, MÁS',
    'Desarrollador: Rockstar Games',
    'Modos: Videojuego multijugador, Videojuego de un jugador',
    'Serie: Red Dead',
    'Primer lanzamiento: 26 de octubre de 2018',
  ],
}
const reviews = { href: '#', average: 5, totalCount: 19000 }

function classNames(...classes) {
  return classes.filter(Boolean).join(' ')
}

export default function RedeadII() {
