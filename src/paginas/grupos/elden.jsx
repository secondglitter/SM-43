...
const product = {
  ...
  breadcrumbs: [
    ...
    { id: 2, name: 'Action and adventure', href: '#' },
    { id: 3, name: 'Role playing games', href: '#' },
  ],
  images: [
    {
      src: '/imagenes/Elden4.jpg',
      alt: 'Two each of gray, white, and black shirts laying flat.',
    },
    {
      src: '/imagenes/Elden2.jpg',
      alt: 'Model wearing plain black basic tee.',
    },
    {
      src: '/imagenes/Elden1.jpg',
      alt: 'Model wearing plain gray basic tee.',
    },
    {
      src: '/imagenes/Elden3.jpg',
      alt: 'Model wearing plain white basic tee.',
    },
  ],
  description:
    'Videojuego de rol de acción desarrollado por FromSoftware y publicado por Bandai Namco Entertainment. El videojuego surge de una colaboración entre el director y diseñador Hidetaka Miyazaki y el novelista de fantasía George R. R. Martin.',
  highlights: [
...
const reviews = { href: '#', average: 5, totalCount: 20000 }
