...
const product = {
  ...
  breadcrumbs: [
    ...
    { id: 2, name: 'Third person', href: '#' },
    { id: 3, name: 'Action', href: '#' },
  ],
  images: [
    {
      src: '/imagenes/ForHonor3.jpg',
      alt: 'Two each of gray, white, and black shirts laying flat.',
    },
    {
      src: '/imagenes/ForHonor2.jpg',
      alt: 'Model wearing plain black basic tee.',
    },
    {
      src: '/imagenes/ForHonor1.jpg',
  ...
  highlights: [
    ...
    'Fecha de estreno inicial: 14 de febrero de 2017',
    'Distribuidor: Ubisoft',
    'Diseñador: Leroy Athanassoff',
    'Programadores: Ubisoft, Ubisoft Montreal, Ubisoft Blue Byte, Ubisoft Toronto, Ubisoft Quebec',
  ],
}
const reviews = { href: '#', average: 5, totalCount: 12000 }

function classNames(...classes) {
  return classes.filter(Boolean).join(' ')
}

export default function ForHonor() {
