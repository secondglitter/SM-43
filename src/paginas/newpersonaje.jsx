...
function NewPersonaje() {
  ...
  const addPersonaje = async () => {
    ...
    try {
      const response = await axios.post("http://localhost:3000/personajes", newpersonaje);
    } catch (error) {
          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                onChange={(e) => setNewPersonaje(e.target.value)}
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-2">
              <input
                ...
                required
                className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                onChange={(e) => setNewJuego(e.target.value)}
              />
            </div>
          </div>
