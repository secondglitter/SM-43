                    ...
                    <div class="p-20 border-dashed">
                        ...
                        <div class="flex items-center justify-center h-48 mb-4 rounded">
                            <div>
                                ...
                                <Link to="/newpersonaje"><button class="inline-flex items-center rounded-md bg-blue-50 px-2 py-1 text-xs font-medium text-blue-700 ring-1 ring-inset ring-blue-700/10">Crear</button> </Link>
                                        ...
                                        <tbody>
                                            ...
                                            {Personajes.map((personajes) => (
                                                ...
                                                <tr class="border-b dark:border-gray-700">
                                                    ...
                                                    <td class="px-6 py-4">
                                                      <Link to={"/updatepesonaje/" + personajes.id}>
                                                        <a  class="font-medium text-blue-600 dark:text-blue-500 hover:underline" >Editar</a>
                                                      </Link>
                                                    </td>
                                                    <td class="px-6 py-4">
                                                        <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" onClick={() =>  HandeDelte(personajes.id)}>Eliminar</a>
                                                    </td>
                                                </tr>
                                            ))}
